...
\newcommand\reporttitle{Cost-performance ratio for object detection}

% Insert course code, name, quartile number and year (or any other subtitle)
\newcommand\reportsubtitle{
ST0256, Numerical Analysis - (2022-2)
}
...
\pagestyle{fancy}
\lhead{\includegraphics[height=14pt]{Figures/0. General/eafit_logo_blue.png}}
\rhead{\reporttitle}
